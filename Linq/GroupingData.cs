    ...
    public static class GroupingData
    {
        ...
        public static IEnumerable<(string category, IEnumerable<string> productsName)> GroupByCategory()
        {
            ...
            var result = products.GroupBy(product => product.Category)
                                    .Where(g => g.Count() <= 7)
                                    .Select(group => (group.Key, ProductNames: group.Select(product => product.ProductName)));
        ...
        public static IEnumerable<IGrouping<string, string>> GroupByCustomComparer()
        {
            ...
            var result = anagrams.GroupBy(word => word.Trim(), new AnagramEqualityComparer());
        ...
        public static IEnumerable<IGrouping<string, string>> NestedGroupByCustom()
        {
            ...
            var result = anagrams.GroupBy(word => word.Trim(), word => word.ToUpper(), new AnagramEqualityComparer());
